...
int main() {
  std::string prompt = R"(
    ...
    DO NOT RETURN ANYTHING EXCEPT THE RESPONSE JSON. DO NOT INCLUDE EXPLICIT FORMATTING OR NEWLINES IN YOUR RESPONSE COMMENTS, AND
    MAKE SURE ANY NEWLINES THAT ARE INCLUDED ARE ESCAPED PROPERLY TO BE INGESTED INTO A JSON PARSER.
